...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<ProductId> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: Array<OrderItem>, arg1: CustomerDetails): Promise<OrderId> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: bigint, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
